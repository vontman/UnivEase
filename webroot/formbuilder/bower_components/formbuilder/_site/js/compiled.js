...
(function() {
  Formbuilder.registerField('number', {
    ...
    addButton: "<span class=\"symbol\"><span class=\"icon-number\">123</span></span> رقم"
  });
...
(function() {
  Formbuilder.registerField('radio', {
    ...
    edit: "<%= Formbuilder.templates['edit/options']({ includeOther: true }) %>",
    addButton: "<span class=\"symbol\"><span class=\"icon-circle-blank\"></span></span> اختيارات متعددة",
    defaultAttributes: function(attrs) {
      attrs.field_options.options = [
        {
          label: "",
...
(function() {
  Formbuilder.registerField('section_break', {
    ...
    addButton: "<span class='symbol'><span class='icon-minus'></span></span> فاصل"
  });
