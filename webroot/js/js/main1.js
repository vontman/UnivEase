  ...
  window.microphone_recorder_events = function microphone_recorder_events() {
    ...
    switch(arguments[0]) {
      ...
      case "recording":
        ...
        FWRecorder.hide();
        $controls.find('.record_button img').attr('src', '../../../img/images/stop.png');
      ...
      case "recording_stopped":
        ...
        FWRecorder.show();
        $controls.find('.record_button img').attr('src', '../../../img/images/record.png');
      ...
      case "playing":
        ...
        $controls = controlsEl(name);
        $controls.find('.record_button img').attr('src', '../../../img/images/record.png');
        $controls.find('.play_button img').attr('src', '../../../img/images/stop.png');
      ...
      case "stopped":
        ...
        $controls = controlsEl(name);
        $controls.find('.record_button img').attr('src', '../../../img/images/record.png');
        $controls.find('.play_button img').attr('src', '../../../img/images/play.png');
