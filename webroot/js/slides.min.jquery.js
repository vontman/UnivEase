...
(function(a){
    a.fn.slides=function(b){
        ...
        b.bigTarget&&(d.children().css({
            ...
            y()
            })),b.generateNextPrev&&(a("."+b.container,c).after('<div class="navigation"><a href="#" class="'+b.prev+'">Prev</a>'),a("."+b.prev,c).after('<a href="#" class="'+b.next+'">Next</a></div>')),a("."+b.next,c).click(function(a){
