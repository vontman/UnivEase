...
if (isset($q_order)&&$q_order)
    echo $form->input("QuestionColumn.$i.c_order", array("div" => "e_right", "after" => '<span class="add-on">' . __("Option Order", true) . '</span>', "class" => " span1 s2", "between" => '<div class="input-append">', "label" => false)) . "</div>";
...
if (!isset($points) || $points)
    echo $form->input("QuestionColumn.$i.points", array("div" => "e_right", "after" => '<span class="add-on">' . __("Grade", true) . '</span>', "class" => " span1 s2 points", "between" => '<div class="input-append">', "label" => false)) . "</div>";
