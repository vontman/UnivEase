...
if (!isset($points) || $points){
    ...
    echo $form->input("QuestionChoice.$i.points", array("div" => "e_right","after" => '<span class="add-on">' . __("Grade", true) . '</span>', "class" => " span1 s2 points", "between" => '<div class="input-append">', "label" => false)) . "</div>";

    //echo $form->text("QuestionChoice.$i.points", array("div" => "e_right","after" => '<span class="add-on">' . __("Grade", true) . '</span>', "class" => " span1 s2 points","between" => '<div class="input-append">', "label" => false)) . "</div>";

    
}

if (!isset($correct) || $correct)
    echo $form->input("QuestionChoice.$i.correct", array("div" => "e_right", "after" => '<span class="add-on">' . __("Correct", true) . '</span>', "class" => " span1 s2 points", "between" => '<div class="input-append">', "label" => false)) . "</div>";
