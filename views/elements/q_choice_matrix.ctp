...
if (!isset($points) || $points)
    echo $form->input("QuestionColumn.$i.QuestionChoice.$j.points", array("div" => "e_right","value"=>0, "after" => '<span class="add-on">' . __("Grade", true) . '</span>', "class" => " span1 s2 points", "between" => '<div class="input-append">', "label" => false)) . "</div>";
if (!isset($correct) || $correct)
    echo $form->input("QuestionColumn.$i.QuestionChoice.$j.correct", array("div" => "e_right", "after" => '<span class="add-on">' . __("correct", true) . '</span>', "class" => " span1 s2 points", "between" => '<div class="input-append">', "label" => false)) . "</div>";
