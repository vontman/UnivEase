...
<?php
if (isset($cuser['Group']['allowed_permissions'][12])) {
    ?>
    ...
    <div class="msghead">
        <ul class="msghead-menu">
            <li>
                ...
                <a class="btn" href="<?php echo Router::url(array('controller' => 'chats', 'action' => 'add', $cuser['Course']['id'], '?' => array('level' => $_GET['level']))) ?>"> 
