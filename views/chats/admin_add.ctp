...
<div class="breadcrumbwidget">
    <ul class="breadcrumb">
        ...
        <span class="divider"> / </span>
        <li><a href="<?php echo Router::url(array('controller' => 'chats', 'action' => 'index', $ccourse['Course']['id'],'?'=>array('level'=>!empty($this->data['Chat']['level'])?$this->data['Chat']['level']:$_GET['level']))) ?>"> <?php echo __('Chat sessions',true) ?></a></li>
        <span class="divider"> / </span>
