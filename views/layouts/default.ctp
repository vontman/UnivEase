...
<html lang="<?php  ?>">
    ...
    <body>
        ...
        <nav class="navbar navbar-default navbar-fixed-top upper-nav" role="navigation">
            ...
            <div style='margin-top: 118px;'class="container">  
    <div class="row">
            <div class="">
                 <!-- Start left panel-->
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-xs-12 col-md-12">
                                    <?php if($users['User']['image']['path']){?>
                                    <a href="<?php echo Router::url(array('controller' => 'users', 'action' => 'profile')) ?>" class="thumbnail">
                                        <img src="<?php echo Router::url($users['User']['image']['thumb1']) ?>" alt="...">
                                    </a>
                                    <?php } ?>
                                    <h4><a href="<?php echo Router::url(array('controller' => 'users', 'action' => 'profile')) ?>"><?php echo $users['User']['name'] ?></a><br class="clear" /></h4>
                                    <h5><a href="<?php echo Router::url(array('controller' => 'faculty', 'action' => 'view',$users['Faculty']['id'])) ?>">Faculty of <?php echo $users['Faculty']['name'] ?></a><br class="clear" /></h5>
                                    <h6><a href="#">type</a></h6>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div style="padding:3%; " class="panel-body">
                            ...
                            <?php if ($this->Session->check('user')) {?>
                                ...
                                <?php for($i=0;$i<count($users['Courses']);$i++){ ?>
                                <div class="col-xs-4 col-md-4">
                                    <a href="<?php echo Router::url(array('controller' => 'groups', 'action' => 'index',$users['Courses'][$i]['id']))?>">
                                        <img src="slide.png" alt="..."><?php echo $users['Courses'][$i]['name']; ?>
                                    </a>
                                </div>
                            <?php } }
            ...
            <a href="<?php echo Router::url(array('controller' => 'faculties', 'action' => 'add','admin'=>'false')) ?>" class="dashboard-module">
                <img src="<?php echo Router::url('/css/images/ico/courses.png') ?>" width="64" />
                                ...
                                <div class="col-xs-4 col-md-4">
            <a href="<?php echo Router::url(array('controller' => 'categories', 'action' => 'add','admin'=>'false')) ?>" class="dashboard-module">
                <img src="<?php echo Router::url('/css/images/ico/courses.png') ?>" width="64" />
            </a>
        </div>
