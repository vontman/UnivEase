    ...
    <div class="msghead">
        <ul class="msghead-menu">
            ...
            <li>
                ...
                <a class="btn" style="height: 21px;" href="<?php echo Router::url(array('controller' => 'users', 'action' => 'add',$course_id)) ?>"> 
                <?php __('Add New user') ?>
                <i class="icon-plus"></i>
            </a>
            </li>
         ...
         <li>
             ...
             <li>
                 ...
                 ?>
                <!--<button class="btn"><span class="iconsweets-alert2"></span> الابلاغ عن الاساءة</button>-->
                <a class="btn" href="<?php echo Router::url(array('controller' => 'course_users', 'action' => 'add_all', $course_id,'?' => array('date' => $end))) ?>"> 
            ...
            <li>
            <!--<button class="btn"><span class="iconsweets-alert2"></span> الابلاغ عن الاساءة</button>-->
                <a class="btn" href="<?php echo Router::url(array('controller' => 'course_users', 'action' => 'approved_all', $course_id)) ?>"> 
                    <?php __('Approved all') ?>
                    <i class="icon-list-alt"></i>
                </a>
            </li>
            ...
            <tr<?php echo $class; ?>>
                ...
                <td class="actions">
                    <?php if (isset($cuser['Group']['allowed_permissions'][8])) { ?>
                        ...
                        <?php echo $html->link('<i class="icon-comment"></i>', array('controller' => 'notes', 'action' => 'send_note', $courseUser['CourseUser']['user_id'],'?'=>array('crs_id'=>$courseUser['CourseUser']['course_id'])), array('class' => 'btn btn-small', "title" => __("Send note", true), 'escape' => false)); ?>
                     ...
                     if($courseUser['CourseUser']['approved']==0){
                             echo $html->link('<i class="icon-ok"></i>', array('action' => 'approved', $courseUser['CourseUser']['id'],'?' => array('crs_id' =>$cuser['Course']['id'])), array('class' => 'btn btn-small', 'escape' => false)); 
                        }
