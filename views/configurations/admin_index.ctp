<h2><span><?php __('Configurations');?></span></h2>
...
?>
	<tr<?php echo $class;?>>
                    <td >
                        <input  type="checkbox" name="chk[]" value="<?php echo $configuration['Configuration']['id']; ?>" /></td>
                    		<td>
			<?php echo $configuration['Configuration']['id']; ?>
		</td>
                    		<td class="actions">
			<?php echo $html->link(__('Edit', true), array('action' => 'edit', $configuration['Configuration']['id']),array('class'=>'Edit')); ?>
			<?php echo $html->link(__('Delete', true), array('action' => 'delete', $configuration['Configuration']['id']), array('class'=>'Delete'), sprintf(__('Are you sure you want to delete # %s?', true), $configuration['Configuration']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
        </table>
